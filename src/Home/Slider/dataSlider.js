...
export const dataSlider = [
  {
    id: uuidv4(),
    title: "Anjali Srivastava, Content Intern",
    description:
  ...
  {
    id: uuidv4(),
    title: "Kshema Unni, Business Development Intern",
    description:
